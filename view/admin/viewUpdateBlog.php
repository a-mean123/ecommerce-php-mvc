...
<form method="POST" class="mt-4 p-5" action="index.php?controller=blog&action=updated" enctype="multipart/form-data">
  <div class="form-group">
    <label for="exampleInputEmail1">Titre de l'article</label>
    <input type="text"  value="<?php echo $u->getTitre();  ?>"   name="titre" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="form-group">
